...
public class Vehicle {
	...
	/*	int updatedyear = vehicle.getYear()!=null? vehicle.getYear():this.getYear();
		this.setYear(updatedyear);
		String updatedRedlineRpm = vehicle.getRedlineRpm()!=null? vehicle.getRedlineRpm():this.getRedlineRpm();
		this.setRedlineRpm(updatedRedlineRpm);
		String updatedMaxFuelVolume = vehicle.getMaxFuelVolume()!=null? vehicle.getMaxFuelVolume():this.getMaxFuelVolume();
		this.setMaxFuelVolume(updatedMaxFuelVolume);*/
		Timestamp updatedLastServiceDate = vehicle.getLastServiceDate()!=null? vehicle.getLastServiceDate():this.getLastServiceDate();
